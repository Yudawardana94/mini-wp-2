<template>
  <div class="card" v-if="data">
    ...
    <span class="content">
      ...
      <!-- <p>{{ data.createdAt | moment("MMM Do YY");  }} || @{{ data.author.username }}</p> -->
    </span>
  </div>
</template>
...
export default {
  ...
  methods: {
    detailPage(data) {
      console.log("yomann");
      console.log(data);
      this.$emit("detailArticle", data);
    }
  },
  created() {
    console.log(this.data, "ini dari cereatednyaa~~");
  }
};
</script>
